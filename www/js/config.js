        ...
        'tab-news': {
          ...
          resolve: {
            init: function (News, $ionicLoading) {
              ...
              return News.populate().then(function (response) {
    ...
    .state('tab.lectures-events', {
      ...
      views: {
        'tab-lectures-events': {
          templateUrl: function () {
            if (ionic.Platform.isAndroid()) {
              return  'templates/tab-lectures-events-android.html';
            }
            return 'templates/tab-lectures-events-ios.html';
          },
          ...
          resolve: {
            init: function (LecturesEvents, $ionicLoading) {
              ...
              return LecturesEvents.populate().then(function (response) {
                angular.forEach(response.data, function (item) {
